 ...
 * @author ruben
 */
public class DialogHangar extends javax.swing.JDialog {
    
    private java.awt.Frame parent;
    /**
     * Creates new form Hangar
     */
    public DialogHangar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogHangar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogHangar dialog = new DialogHangar(new javax.swing.JFrame(), true);
